            ...
            <form className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg bg-white/10 border border-white/20 font-Text text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-secondary"
                />
              </div>
            ...
            <div className="space-y-6 text-white/90 text-base font-Text">
              ...
              <div className="mb-8 rounded-xl overflow-hidden border border-white/10">
                <iframe
                  ...
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3782.0032220917786!2d73.8966674!3d18.4732608!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2ea6f0b41a257%3A0xcef2546d5e1b3c1!2sClover%20Highlands!5e0!3m2!1sen!2sin!4v1712738892569!5m2!1sen!2sin"
                  width="100%"
                  height="200"
                  allowFullScreen
                  loading="lazy"
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-white/80 hover:text-white transition duration-300 relative after:content-[''] after:absolute after:left-0 after:bottom-0 after:w-0 after:h-[2px] after:bg-white hover:after:w-full after:transition-all after:duration-300"
                  >
