...
type PolymorphicRef<C extends ElementType> = Ref<
...
const Button: ButtonComponent = forwardRef(
  <C extends React.ElementType>(
    ...
    const generalStyles = [
      ...
      "[&:hover:not(:disabled)]:border-opacity-90", // On hover and not disabled
    ...
    // Main Colors
    const primary = [
      "bg-primary border-primary text-white dark:border-primary [&:hover:not(:disabled)]:bg-primary/90", // Default
    ];
    const secondary = [
      "bg-secondary/70 border-secondary text-slate-500", // Default
      "dark:border-darkmode-400 dark:bg-darkmode-400 dark:text-slate-300", // Dark mode
      "[&:hover:not(:disabled)]:bg-secondary/90 [&:hover:not(:disabled)]:border-secondary/90", // On hover and not disabled
